...
**English** | [简体中文](https://github.com/asu-idi/toktier/blob/v0.2.8/README.zh-CN.md)
...
- **Fast on both paths.** On the recorded benchmark battery, the GPU path
  ...
  [benchmark protocol](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/benchmarks.md) excludes engine construction,
...
![Latency head-to-head: TokTier versus full re-encode across three workloads of a 4M-character session](https://raw.githubusercontent.com/asu-idi/toktier/v0.2.8/docs/figures/hero_session_vs_reencode.svg)
...
[`hero_session_vs_reencode.data.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/figures/hero_session_vs_reencode.data.json);
the complete sweeps are in [`docs/benchmarks.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/benchmarks.md).
...
- **2026.08.30** 🚀 **toktier 0.2.8** released — on the Python face the
  ...
  [v0.2.8 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.8.md).
- **2026.08.27** 🚀 **toktier 0.2.7** released — `pip install
  ...
  [v0.2.7 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.7.md).
- **2026.08.27** 🚀 **toktier 0.2.6** released — Rust certification now
  ...
  IDs, the store format, and the kernel ABI are unchanged. See the
  [v0.2.6 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.6.md).
- **2026.08.15** 🚀 **toktier 0.2.5** released — the Rust crate's `network`
  ...
  [v0.2.5 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.5.md).
- **2026.08.14** 🚀 **toktier 0.2.4** released — the Han family (`kimi_k3`)
  ...
  [v0.2.4 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.4.md).
- **2026.08.11** 🚀 **toktier 0.2.1** released — a maintenance update: richer
  ...
  [v0.2.1 release notes](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.1.md).
...
[`docs/support-matrix.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/support-matrix.md#status-vocabulary).
...
registry. See [`docs/rust-api.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/rust-api.md) for the serving surface and
[`docs/rust-lifecycle.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/rust-lifecycle.md) for acquisition, JIT,
...
materialization. See [`docs/native-routing.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/native-routing.md).
...
The [provenance and build record](https://github.com/asu-idi/toktier/blob/v0.2.8/packaging/fast_cpu/README.md) pins the
...
than a machine-local binary. See [`docs/gpu-jit.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/gpu-jit.md) for the
...
[`docs/rust-lifecycle.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/rust-lifecycle.md).
...
certified corpora.
[`docs/support-matrix.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/support-matrix.md#configuration-only-added-tokens)
...
[`evidence/evidence_manifest.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/evidence/evidence_manifest.json),
[`evidence/evidence_manifest_added_families.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/evidence/evidence_manifest_added_families.json),
[`evidence/evidence_manifest_kimi_band.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/evidence/evidence_manifest_kimi_band.json),
and [`tables/support_registry.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/tables/support_registry.json). Shipped
...
kept in
[`readings/fast_cpu_focused_parity.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/readings/fast_cpu_focused_parity.json).
The executing one-call Rust front end is separately checked across all 11
CPU-fast artifacts in
[`readings/fast_cpu_native_frontend_parity.json`](https://github.com/asu-idi/toktier/blob/v0.2.8/readings/fast_cpu_native_frontend_parity.json).
...
provenance are in [`docs/benchmarks.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/benchmarks.md).
...
![Single-request latency](https://raw.githubusercontent.com/asu-idi/toktier/v0.2.8/docs/figures/f1_single_request_latency.svg)

![Session tail latency](https://raw.githubusercontent.com/asu-idi/toktier/v0.2.8/docs/figures/f2_session_tail_latency.svg)

![Session state memory](https://raw.githubusercontent.com/asu-idi/toktier/v0.2.8/docs/figures/f3_session_state_memory.svg)

![Repair-path equivalent throughput](https://raw.githubusercontent.com/asu-idi/toktier/v0.2.8/docs/figures/f4_repair_equivalent_throughput.svg)
...
[`docs/support-matrix.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/support-matrix.md) lists every anchor artifact,
...
See [`docs/integration/dynamo.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/integration/dynamo.md) for using the two
layers together.

## Documentation

- [`docs/releases/v0.2.8.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/releases/v0.2.8.md) — release notes for this version.
- [`ARCHITECTURE.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/ARCHITECTURE.md) — layers, routing, and store format.
- [`ROADMAP.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/ROADMAP.md) — release scope and planned integration.
- [`docs/support-matrix.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/support-matrix.md) — artifacts and covered repositories.
- [`docs/gpu-jit.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/gpu-jit.md) — prebuilt and JIT GPU deliveries.
- [`docs/rust-api.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/rust-api.md) — Python-free Rust serving API.
- [`docs/rust-lifecycle.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/rust-lifecycle.md) — native artifacts, direct JIT, concurrency, and offline distribution.
- [`docs/integration/dynamo.md`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/integration/dynamo.md) — Dynamo integration.
- [`docs/paper/toktier-preprint.pdf`](https://github.com/asu-idi/toktier/blob/v0.2.8/docs/paper/toktier-preprint.pdf) — current preprint.
...
[`THIRD_PARTY_NOTICES`](https://github.com/asu-idi/toktier/blob/v0.2.8/THIRD_PARTY_NOTICES) and [`packaging/`](https://github.com/asu-idi/toktier/tree/v0.2.8/packaging).

## License and citation

toktier is licensed under the [Apache License 2.0](https://github.com/asu-idi/toktier/blob/v0.2.8/LICENSE); see
[`NOTICE`](https://github.com/asu-idi/toktier/blob/v0.2.8/NOTICE) for attribution information.
...
[`CITATION.cff`](https://github.com/asu-idi/toktier/blob/v0.2.8/CITATION.cff).
