#!/usr/bin/env python3
"""Generate the license bundle for the vendored Gigatoken native module.

The input is Cargo's locked metadata for the corrected Gigatoken checkout.
Every normal dependency reachable on any target is included.  This is a
deliberately conservative superset of the Linux binary's linked closure; it
prevents a target predicate or procedural-macro edge from silently dropping
...
HEADER = """THIRD-PARTY LICENSE BUNDLE FOR TOKTIER'S VENDORED GIGATOKEN MODULE
=======================================================================

Generated from the locked Cargo metadata of corrected Gigatoken
0.10.0+toktier.pinned.1 (upstream commit
34a1599f0c0ae7d7cd0d1c530e6522320158b360). The dependency walk includes
every normal edge on every target, so it is a conservative superset of the
Linux x86-64 native module's linked dependency closure.
